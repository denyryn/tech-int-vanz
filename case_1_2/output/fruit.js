...
// Nomor 1
console.log("\n====== 1 ======");
const getNormalizedFruits = (fruits) => {
    const grouped = {};
    const result = [];
...
// Nomor 2
console.log("\n====== 2 ======");
const separateContainers = (fruits) => {
...
for (const key in getContainerFruits(containers)) {
    console.log(key +
        " : " +
        getContainerFruits(containers)[key].split(", ")
            .map((fruit) => toCapitalized(fruit))
            .join(", "));
}
// Nomor 3
console.log("\n====== 3 ======");
const getContainerTotalStock = (container) => {
    let total = 0;
...
console.log("Total stock buah di container LOCAL : " +
    getContainerTotalStock(containers.LOCAL));
console.log("Total stock buah di container IMPORT : " +
